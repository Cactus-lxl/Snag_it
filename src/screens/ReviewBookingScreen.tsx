...
export default function ReviewBookingScreen({ navigation, route }: ReviewBookingScreenProps) {
  ...
  // Calculate total without tax and security deposit
  const actualTotal = useMemo(() => {
    return priceBreakdown.base + priceBreakdown.service;
  }, [priceBreakdown]);

  const handlePayment = () => {
    // Navigate to payment screen with updated total
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.priceRow}>
            ...
            <Text style={styles.totalValue}>{formatCurrency(actualTotal)}</Text>
          </View>
        </View>
        ...
        <View style={styles.infoBox}>
          ...
          <Text style={styles.infoText}>
            No additional taxes or security deposit required. Your payment is secure and protected.
          </Text>
        </View>
      </ScrollView>
      ...
      <View style={styles.footer}>
        <View style={styles.totalFooter}>
          ...
          <Text style={styles.footerTotal}>{formatCurrency(actualTotal)}</Text>
        </View>
